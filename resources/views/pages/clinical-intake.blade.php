...
@section('content')
    <section class="hw-section bg-hw-white">
        <x-layout.page-container narrow class="text-center">
            ...
            @else
                <p class="mt-8 text-hw-muted text-base">Clinical portal URL will be configured by your HeartWell team.</p>
            @endif
            <a href="{{ route('contact') }}" class="block mt-4 text-hw-blush hover:text-hw-heading text-base">Return to Contact</a>
